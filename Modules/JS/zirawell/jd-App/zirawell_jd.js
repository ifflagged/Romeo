...
const blockId = blockList.find(blockId => (body.includes(blockId) || url.includes(blockId)));
const convertId = convertList.find(convertId => (body.includes(convertId) || url.includes(convertId)));
